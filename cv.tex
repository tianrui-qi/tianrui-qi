...
\section{Education}
    ...
    \textbf{Ph.D. in Biomedical Engineering \hfill 09/2025 - 05/2030} \\
...
\section{Publications \hfill {\normalsize \normalfont $\dag$: contributed equally}}
    ...
    \textbf{Bio-CM$^{2}$: A Computational Miniature Mesoscope \\ Enabling Cortex-Wide Cellular Imaging in Mice \hfill 2026}\\
    \textit{Manuscript in Preparation} \\
    \textit{Guorong Hu, Tianrui Qi, et al., Lei Tian}

    \subsectionvspace

    \textbf{Volumetric Localization Microscopy with Deep Learning \hfill 2025}\\
    \textit{Nature Communications} \\
    \textit{Keyi Han$^\dag$, Xuanwen Hua$^\dag$, Tianrui Qi$^\dag$, Zijun Gao, Xiaopeng Wang, Shu Jia} \\
    DOI: \href{https://doi.org/10.1038/s41467-025-65941-3}{\underbar{doi.org/10.1038/s41467-025-65941-3}}

    \subsectionvspace

    \textbf{Superiority of Quadratic Neural Networks for Classification of Gaussian Mixture Data \hfill 2022} \\
    \textit{Visual Computing for Industry, Biomedicine, and Art} \\
    \textit{Tianrui Qi, Ge Wang} \\
